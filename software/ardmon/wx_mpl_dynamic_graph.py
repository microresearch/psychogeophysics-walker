...
# TODO: time to init!
# TODO: check of each stream of all sources for sanity and warn if not looking good 
# TODO: 10 or 11 data sources incoming
# TODO: choose which to plot (we don't plot GPS tho just check sanity)
